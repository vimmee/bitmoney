                ...
                <div class="row">
                    ...
                    <div class="col-lg-9 col-md-9 col-sm-12 col-xs-6">
                        <div class="menu-area  hidden-xs">
                            ...
                            <div class="login-btn">
                                <a href="form/login-user.php" class="btn1"><i class="fa fa-user"></i><span>Login</span></a>
                            </div>
                        </div>
                                    ...
                                    <div class="row">
                                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                            <div class="slider-content">
                                                ...
                                                <div class="buttons">
                                                    <a href="form/signup-user.php" class="btn1" data-animation="animated bounceInUp">Join Us</a>
                                                    <a href="form/signup-user.php" class="btn2" data-animation="animated bounceInUp">Buy Tokens Now!</a>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 hidden-xs hidden-sm">
                                            <div class="btc_timer_section_wrapper">
                                                <div id="clockdiv">
                                                    <p><strong>RECEIVE YOUR BONUS NOW</strong></p>
                                                    <div>
                ...
                <div class="row">
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                        <div class="about-content">
                            ...
                            <div class="buttons">
                                <a href="form/signup-user.php" class="btn1">Join Us</a>
                                <a href="form/signup-user.php" class="btn3">Buy Tokens Now!</a>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                                                ...
                                                <div class="box-con">
                                                    <div class="dbox">
                                                        ...
                                                        <div class="dright">
                                                            <div class="content">
                                                                <p>(3Q 2020)</p>
                                                                <h3>BitMoney<br> Landing page</h3>
                                                            </div>
                                                        </div>
                                                    </div>
                                                </div>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right wow  fadeInUp animated" data-wow-duration="1.3s" style="visibility: visible; animation-duration: 1.3s; animation-name: fadeInUp;">
                                <div class="tokens mr-l50">
                                    ...
                                    <div class="token-body">
                                        ...
                                        <a href="form/signup-user.php" class="left-btn">Price 1 BIT – $0.25</a>
                            ...
                            <div class="col-lg-6 col-md-6 col-sm-6 col-xs-12 text-right wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">
                                <div class="tokens mr-r50">
                                    ...
                                    <div class="token-body">
                                        ...
                                        <a href="form/signup-user.php" class="right-btn">Price 1 BIT - $1.00</a>
                                        <div class="prices">
                ...
                <div class="row">
                    ...
                    <div class="col-lg-8 col-md-8 col-sm-12 col-xs-12 col-lg-offset-2 col-md-offset-2">
                        ...
                        <div class="contents text-center">
                            ...
                            <a href="#" class="btn1  wow  fadeInUp animated" data-wow-duration="1.6s" style="visibility: visible; animation-duration: 1.6s; animation-name: fadeInUp;">Join Us</a>
                        </div>
                    </div>
                </div>
            </div>
            ...
            <div id="particles-team">
                <div class="container">
                    <div class="row">
                        <div class="col-lg-12 col-md-12 col-sm-12 col-xs-12">
                            <div class="section-heading2">
                                <h2 class="wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name:





" style="enable-background:new 0 0 1920 181.1;" xml:space="preserve">
                <style type="text/css">
                    .st0 {
                        fill-rule: evenodd;
                        clip-rule: evenodd;
                    ...
                    <div class="row">
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="copyright wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">
                                <p>© 2017-2021 <a href="form/login-user.php"><span>Bit Money</span></a> | All rights reserved.
                                    <a href="#" target="_blank"> <span>BitMoney</span></a>
                                </p>
                            </div>
                        </div>
                        <div class="col-lg-6 col-md-6 col-sm-12 col-xs-12">
                            <div class="foo-link wow  fadeInUp animated" data-wow-duration="1.0s" style="visibility: visible; animation-duration: 1.0s; animation-name: fadeInUp;">
                                <ul>
                                    <li><a href="form/login-user.php">Bitmoney</a></li>
